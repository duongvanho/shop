...
public final class ItemOrderHistoryBinding implements ViewBinding {
  ...
  private ItemOrderHistoryBinding(@NonNull ConstraintLayout rootView, @NonNull TextView tvOrderDate,
      @NonNull TextView tvOrderId, @NonNull TextView tvOrderItems, @NonNull TextView tvOrderTotal) {
  ...
  public static ItemOrderHistoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemOrderHistoryBinding((ConstraintLayout) rootView, tvOrderDate, tvOrderId,
          tvOrderItems, tvOrderTotal);
    }
